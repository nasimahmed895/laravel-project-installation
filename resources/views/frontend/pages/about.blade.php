                                ...
                                <div class="card-body shadow-black   pt-3 pb-4   px-lg-3 ">
                                    <div class="center">
                                        ...
                                        <div class="social_info height">
                                            <a href="{{ get_option('ceo_facebook') }}" target="_blank"><i
                                                    class="fab fa-facebook-f"></i></a>
                                            <a href="{{ get_option('ceo_twitter') }}" target="_blank"><i
                            ...
                            <div class=" text-center right">
                                <div class="card-body shadow-black   pt-3 pb-4   px-lg-3 ">
                                    <div class="center">
                                        ...
                                        <div class="social_info height">
                                            <a href="{{ get_option('co_facebook') }}" target="_blank"><i
                                                    class="fab fa-facebook-f"></i></a>
                                            <a href="{{ get_option('co_twitter') }} " target="_blank"><i
                                                    class="fab fa-whatsapp"></i></a>
